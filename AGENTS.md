...
- `argocd_register.py` - `ArgocdPauseRegister`: the pause register (entries = unresolved resume obligations — confirmed, provisional, or unknown; see ADR-0001); pause/resume/status across hubs, used by PrimaryPrep, restore-only mode, and resume paths
