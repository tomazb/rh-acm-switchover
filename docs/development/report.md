...
| F-08 | StateManager reentrant flush | Reentrant dirty state set during a flush is preserved and flushed again after the active write completes. | Fixed |
| F-09 | Audit documentation drift | Superseded by this closeout table; protected runbook content was not changed. | Superseded |
