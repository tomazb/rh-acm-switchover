...
| 17 | in_progress | `fix/thermos-klusterlet-secret-ordering` | `.worktrees/thermos-17-klusterlet-secret-ordering` | F34 | _TBD_ | Replace delete-then-create klusterlet bootstrap secret remediation with parity-preserving patch/create semantics and realign managed-cluster RBAC/docs from delete to patch. |
