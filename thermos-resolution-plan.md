...
| 08 | in_progress | `fix/thermos-rbac-managed-cluster-parity` | `.worktrees/thermos-08-rbac-parity` | F8, F26 | unopened | RBAC parity, validator, and manifest parity tests |
