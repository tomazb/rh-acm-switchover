...
these checks do not confirm: `error` for a mismatch or unreadable discovery,
and `kind_not_served` for an omitted kind. Python reports each as absence. For
...
namespace, observability teardown
