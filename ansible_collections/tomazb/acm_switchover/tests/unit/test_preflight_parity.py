...
def test_validate_backups_enforces_backup_and_cluster_parity_checks():
    ...
    assert "useManagedServiceAccount" in text, "validate_backups.yml must enforce BackupSchedule useManagedServiceAccount"
    ...
    assert "clusters imported after latest backup will be lost" in text, (
