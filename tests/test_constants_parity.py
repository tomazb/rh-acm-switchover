...
CONSTANT_PAIRS = {
    ...
    # R4-03 MCH owner-chain classification (plan §11C.1)
    "ACM_OPERATOR_POD_PREFIX": "ACM_OPERATOR_POD_PREFIX",
    "POD_CLASSIFICATION_OPERATOR_OWNED": "POD_CLASSIFICATION_OPERATOR_OWNED",
    "POD_CLASSIFICATION_DRAIN_BLOCKING": "POD_CLASSIFICATION_DRAIN_BLOCKING",
    "POD_CLASSIFICATION_IDENTITY_UNAVAILABLE": "POD_CLASSIFICATION_IDENTITY_UNAVAILABLE",
    "POD_CLASSIFICATION_IDENTITY_INCONSISTENT": "POD_CLASSIFICATION_IDENTITY_INCONSISTENT",
    # R4-03 MCH operator identity capture: the OLM CSV contract both form factors read (§11C.2)
    "CSV_API_GROUP": "CSV_API_GROUP",
    "CSV_API_VERSION": "CSV_API_VERSION",
    "CSV_PLURAL": "CSV_PLURAL",
    "CSV_PHASE_SUCCEEDED": "CSV_PHASE_SUCCEEDED",
    "CSV_INSTALL_STRATEGY_DEPLOYMENT": "CSV_INSTALL_STRATEGY_DEPLOYMENT",
}
