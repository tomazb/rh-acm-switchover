...
class TestPostActivationVerification:
    ...
    def test_verify_success_with_observability(self, mock_wait, post_verify_with_obs, mock_secondary_client, mock_state_manager):
    ...
    @patch('modules.post_activation.wait_for_condition')
    def test_verify_success_without_observability(self, mock_wait, post_verify_no_obs, mock_secondary_client, mock_state_manager):
    ...
    @patch('modules.post_activation.wait_for_condition')
    def test_observability_verification_conditional(self, mock_wait, mock_secondary_client, mock_state_manager, has_obs):
