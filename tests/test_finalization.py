...
class TestFinalization:
    ...
    def test_finalize_success(self, mock_time, finalization, mock_secondary_client, mock_state_manager, mock_backup_manager):
        ...
        mock_secondary_client.list_custom_resources.side_effect = [
            ...
            [{'metadata': {'name': 'backup-1'}, 'status': {'phase': 'InProgress'}}]  # Second check: new backup
        ]
