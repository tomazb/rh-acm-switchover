...
- Prevented Python and collection preflight logs from publishing raw validation messages, exception text, credential-derived identifiers, API details, or Argo CD Application names. Python structured validation results and both form factors' machine-readable report contracts remain unchanged.
