...
class InputValidator:
    ...
    def validate_all_cli_args(args: object) -> None:  # noqa: C901
        ...
        if is_restore_only:
            ...
            # --argocd-manage and --argocd-resume-after-switchover are allowed with --restore-only.
            # The new _pause_argocd_for_restore() helper handles pausing on the target hub before ACTIVATION.
